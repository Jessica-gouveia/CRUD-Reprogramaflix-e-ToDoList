...
const createMovie = (request, response) => {
    ...
    const deleteMovie = (request, response) => {
        ...
        response.status(200).send({
            "message": "Filme deletado com sucesso!", movies
        })
    }
    ...
    const replaceMovie = (request, response) => {
        ...
        response.status(200).send({
            "message": "Filme atualizado com sucesso!!", updateMovie
        })
    ...
    const updateAnything = (request,response) => {
        ...
        response.status(200).send({
            "message": "Informação atualizada com sucesso!!", filteredId
        })
    }
    ...
    module.exports = { home, getAll, getById, getByTitle, getByGenre, createMovie, deleteMovie, replaceMovie, updateTitle, updateAnything }